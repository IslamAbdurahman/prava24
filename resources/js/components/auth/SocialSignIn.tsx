...
const SocialSignIn = () => {
    ...
    useEffect(() => {
        ...
        script.async = true;
        script.setAttribute('data-telegram-login', 'Prava24Bot');
        script.setAttribute('data-size', 'large');
        script.setAttribute('data-userpic', 'false');
        script.setAttribute('data-request-access', 'write');
        script.setAttribute('data-auth-url', 'https://panel.prava24.uz/auth/telegram/callback');
    ...
    return (
        <div className="w-full space-y-4">
            ...
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-300 p-4 dark:border-slate-700">
                <p className="mb-3 text-xs font-semibold tracking-wider text-gray-500 uppercase dark:text-gray-400">Or sign in with</p>
